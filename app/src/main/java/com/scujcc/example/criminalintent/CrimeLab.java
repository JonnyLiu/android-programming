...
import com.scujcc.example.criminalintent.database.CrimeBaseHelper;
import com.scujcc.example.criminalintent.database.CrimeCursorWrapper;
...
public class CrimeLab {
    ...
    private static ContentValues getContentValues(Crime crime) {
        ...
        values.put(CrimeTable.Cols.INTRODUCE, crime.getmIntroduce());
        return values;
    }
